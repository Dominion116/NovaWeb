    ...
    <section className="relative overflow-hidden bg-background py-20 sm:py-32 lg:pb-32 xl:pb-36">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="mx-auto max-w-2xl">
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-primary via-purple-400 to-primary">
            NovaWeb Services
          </h1>
          <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-xl mx-auto">
            Modern websites built for performance, scalability, and impact. We transform your digital vision into stellar reality.
          </p>
